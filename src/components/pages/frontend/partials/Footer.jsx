    ...
    <footer className="py-20">
      <div className="container">
        <div className="grid md:grid-cols-[1.5fr,_1fr,_1fr,_.8fr] gap-5">
          <div className="footer-box max-w-[500px]">
          ...
          <div className="footer-box">
           ...
           <ul>
            <li><Link to="/">Sureshot Jogger</Link></li>
            <li><Link to="/">Flintlock Tees</Link></li>
            <li><Link to="/">Sustainable Products</Link></li>
            <li><Link to="/">ZANEROBE Pants</Link></li>
            <li><Link to="/">ZANEROBE Tee Shirts</Link></li>
            <li><Link to="/">ZANEROBE Jackets</Link></li>
            <li><Link to="/">ZANEROBE Shorts</Link></li>
            <li><Link to="/">ZANEROBE Sale</Link></li>
            <li><Link to="/">Chinos</Link></li>
            <li><Link to="/">Denim</Link></li>
            <li><Link to="/">Joggers</Link></li>
            <li><Link to="/">Hoodies</Link></li>
            <li><Link to="/">REC GEN</Link></li>
          ...
          <ul>
             ...
             <li><Link to="/">Submit a Return Request</Link></li>
             <li><Link to="/">Shipping Info</Link></li>
             <li><Link to="/">Technical & Privacy</Link></li>
             <li><Link to="/">Mobile App</Link></li>
             <li><Link to="/">Site Reviews</Link></li>
             <li><Link to="/">Promotions</Link></li>
             <li><Link to="/">ZANEROBE Loyalty</Link></li>
             <li><Link to="/">Refer a Friend</Link></li>
             <li><Link to="/">Those Who Wear</Link></li>
             <li><Link to="/">Bundles</Link></li>
           </ul>
           </div>

        <div className="footer-box">
          <h6 className="mb-5">Unlock 15% Off Your Order</h6>
          <p className="mb-8">Sign up to our newsletter to unlock 15% off your 
            order and to be first to hear about new drops plus 
            get VIP access to exclusive releases, re-stocks, sales & more.
          </p>
          ...
          <ul className="flex gap-5 mt-12 items-center">
            <li>
              <Link to="/"> 
        ...
        <p className="text-center py-2 text-xs mb-0">
           2024 ZANEROBE. Designed in Syndey, Australia.
        </p>
      </div>
    </footer>
  );
